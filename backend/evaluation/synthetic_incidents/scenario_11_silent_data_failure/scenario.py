...
class SilentDataFailureScenario(BaseSyntheticScenario):
    @property
    def name(self) -> str:
        return "Silent Data Failure"
    ...
    def context(self) -> str:
        return "DAG succeeds but rows processed drops to 0"
    ...
    def get_ground_truth(self) -> GroundTruth:
        return GroundTruth(
            ...
            expected_confidence_level=ConfidenceLevel.LOW,
